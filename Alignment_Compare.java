/*This program parses through an alignment and flags each sequences that does not align with any other sequences by 20
amino acids. Upon finding a non-aligning sequence, it counts the number of sequences that do not overlap with it by at
least 20. Upon parsing through the entire alignment, the sequences with the highest number of counts, is deleted. The
program then cycles back through the alignment and recounts. It continues to do this until all sequences align with
all other sequences by at least 20 amino acids. Ties are broken by deleting the shortest sequence in the tie.

This program was developed by Damien S. Waits with specifications and design input from Kevin M. Kocot. 
Version July 3rd, 2015. */
...
public class AlignmentCompare {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Sanity check to determine if the correct parameters were input.
        if (args[0] == null) {
            System.out.print("Please give an input file.");
            System.exit(0);
